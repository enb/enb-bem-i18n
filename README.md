...
common.blocks/
    block1/
        ...
        block1.i18n/         # Директория для хранения файлов с переводами для разных языков.
            ...
            общие переводы (в данном случае для русского и английского языков).
...
**Важно!** Для получения ядра необходимо добавить `mustDeps`-зависимость от `{ block: 'i-bem', elem: 'i18n' }` блокам, которые используют i18n.
